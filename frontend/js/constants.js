const contractAddress = "0xCEA1423962C910992D794f49c168F5D495BD2453"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to Tomato Valley!";
const welcome_h2 = "Connect to Metamask to get started.";
const welcome_p = 'Tomato Valley is a place where unique tomatoes live.';
const h1_presale_coming_soon = "NFT Drop Coming Soon!!";
const h1_presale_mint = "Pre-Sale Minting Open!!";
const h1_public_mint = "Minting is live!";
...
const p_public_mint = "Mint now and join the amazing community!";
